...
<body>
	...
	<?php 
 connect_db();
 $sql= "SELECT a.id_a,r.id_user,a.artist,a.value,r.id_auto1,r.id_auto2,r.id_auto3 from autograf a join requests r on a.id_a=r.id_wanted where a.id_user=$_SESSION[user_id]";
 ...
 <div class="viewAuto" style="padding-left: 3%; margin-left: 0.3%; margin-top: 0.2vw; border-style: solid; border-color: red; width: 96%; height: 15vw; background-color: #660000; margin-bottom: 0px;">
  <?php $sql_2="SELECT photo,firstname,lastname,username,phone,email from users where id=?";
...
<?php }} ?>
  <form style="width: 8%; float: right; margin-right: 1%; margin-top: 5%;" method="post">
  <input type="submit" name="send_offer" value="ACCEPT!" style="float: right; font-size: 1vw; margin-right: 0.2vw; text-align: center;  color: #ffbf80; background-color: #660000; font-style: italic; font-family: serif; width: 100%; margin-bottom: 33%;">
  <input type="submit" name="send_offer" value="DECLINE!" style="float: right; font-size: 1vw; margin-right: 0.2vw; text-align: center;  color: #ffbf80; background-color: #660000; font-style: italic; font-family: serif; width: 100%;">
</form>
</div>
<?php
}}
